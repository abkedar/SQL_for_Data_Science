...
-- This will immediately make user to enter a new password when he/she tries to make connection
ALTER USER 'tempuser'@'%' PASSWORD EXPIRE;

-- expire in 90 days fot that particular user
GRANT USER 'tempuser'@'%' PASSWORD EXPIRE INTERNAL 90 DAY;
